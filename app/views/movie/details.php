            ...
            <div class="col-md-9">
                ...
                <?php if ($isAuthenticated): ?>
                    <form action="/movie/generateReview" method="post">
                        ...
                        <input type="hidden" name="query" value="<?php echo htmlspecialchars($query ?? ''); ?>">
                        <button type="submit" class="btn btn-primary" onclick="setTimeout(() => { this.disabled=true; this.innerHTML='<span class=\'spinner-border spinner-border-sm me-2\'></span>Generating Review...'; }, 10);">Get AI Review</button>
